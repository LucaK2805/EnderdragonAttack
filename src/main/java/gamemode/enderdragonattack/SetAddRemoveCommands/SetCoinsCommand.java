...
public class SetCoinsCommand implements CommandExecutor {
    ...
    private static final String PERMISSION = "enderdragonattack.setcoins";
    private static final String USAGE = ChatColor.RED + "Usage: /setcoins <player> <amount>";
    ...
    private static final String SUCCESS_MESSAGE = ChatColor.GREEN + "Coins set to %d for player %s";
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        playerDataBase.setPlayerCoins(targetPlayer, amount);
